...
class TransaksiController extends Controller
{
    ...
    /**
     * Kembalikan buku Tugas 1 Pertemuan 14 dan update pertemuan 15
     */
    public function kembalikan(string $id)
    {
        try {
            DB::transaction(function () use ($id) {
                ...
                // Cek apakah sudah dikembalikan - Pertemuan 15
    ...
    /**
     * Laporan Transaksi - Tugas 2 Pertemuan 14
     */
    ...
    /**
     * Laporan Transaksi pdf - Tugas 2 Pertemuan 14
     */
    public function laporanPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('transaksi.laporan_pdf', compact('transaksis'));
